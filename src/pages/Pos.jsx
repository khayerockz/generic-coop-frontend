...
const Pos = (props) => {
     ...
     useEffect(() => {
          const fetchEmp = async () => {
               const response = await fetch('https://generic-coop-backend.onrender.com/api/customer', {
                    headers: {
     ...
     useEffect(() => {
          const fetchCustomer = async () => {
               const response = await fetch('https://generic-coop-backend.onrender.com/api/credit', {
                    headers: {
                         'Authorization': `Bearer ${user.token}`
                    }
               })
     ...
     useEffect(() => {
          const fetchDrawerStatus = async () => {
               const response = await fetch('https://generic-coop-backend.onrender.com/api/drawer/', {
                    headers: {
                         'Authorization': `Bearer ${user.token}`
                    }
               })
     ...
     useEffect(() => {
          const fetchProduct = async () => {
               const response = await fetch('https://generic-coop-backend.onrender.com/api/product', {
                    headers: {
                         'Authorization': `Bearer ${user.token}`
                    }
               })
     ...
     const handleUpdateStocks = async (e) => {
          ...
          for (let i = 0; i < arr.length; i++) {
               ...
               const response = await fetch('https://generic-coop-backend.onrender.com/api/product/' + arr[i].id, {
                    method: 'PATCH',
     ...
     const handleSaveTransaction = async (e) => {
          ...
          if (cash >= amoundue) {
               ...
               if (
                    ...
                    const response = await fetch('https://generic-coop-backend.onrender.com/api/pos/', {
                         method: 'POST',
     ...
     const handlePatch = async (e) => {
          ...
          if (
               ...
               const response = await fetch('https://generic-coop-backend.onrender.com/api/product/' + id, {
                    method: 'PATCH',
                    body: JSON.stringify(product),
                    headers: {
                         'Content-Type': 'application/json',
