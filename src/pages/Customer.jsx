...
const Customer = (props) => {
     ...
     const handlePatch = async (e) => {
          ...
          if (
               ...
               const response = await fetch('https://generic-coop-backend.onrender.com/api/customer/' + id, {
                    method: 'PATCH',
                    body: JSON.stringify(customer),
                    headers: {
                         'Content-Type': 'application/json',
     ...
     const handlePaymentDelete = async () => {
          const response = await fetch('https://generic-coop-backend.onrender.com/api/credit/' + paymentid, {
               method: 'DELETE',
               headers: {
                    'Authorization': `Bearer ${user.token}`
               }
     ...
     useEffect(() => {
          const fetchCustomer = async () => {
               if (user) {
                    const response = await fetch('https://generic-coop-backend.onrender.com/api/credit' + customer_id, {
                         headers: {
                              'Authorization': `Bearer ${user.token}`
                         }
                    });
