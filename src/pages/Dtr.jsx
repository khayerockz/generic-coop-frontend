...
const Dtr = (props) => {
     ...
     useEffect(() => {
          const fetchDepartment = async () => {
               const response = await fetch('https://generic-coop-backend.onrender.com/api/departments', {
                    headers: {
     ...
     const handleDelete = async () => {
          ...
          const response = await fetch('https://generic-coop-backend.onrender.com/api/dtr/' + id, {
               method: 'DELETE',
               headers: {
                    'Authorization': `Bearer ${user.token}`
               }
     ...
     const handleAddAdditional = async (e) => {
          ...
          const response = await fetch('https://generic-coop-backend.onrender.com/api/additional', {
               method: 'POST',
