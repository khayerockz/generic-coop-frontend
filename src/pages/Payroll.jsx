...
const Payroll = (props) => {
     ...
     useEffect(() => {
          const fetchEmp = async () => {
               const response = await fetch(`https://generic-coop-backend.onrender.com/api/dtr/employee/${employeeId}`, {
                    headers: {
     ...
     useEffect(() => {
          const fetchEmp = async () => {
               const response = await fetch(`https://generic-coop-backend.onrender.com/api/payslip/`, {
                    headers: {
                         'Authorization': `Bearer ${user.token}`
                    }
               })
     ...
     useEffect(() => {
          const fetchEmp = async () => {
               const response = await fetch(`https://generic-coop-backend.onrender.com/api/dtr/`, {
                    headers: {
                         'Authorization': `Bearer ${user.token}`
                    }
               })
     ...
     useEffect(() => {
          const fetchEmp = async () => {
               const response = await fetch('https://generic-coop-backend.onrender.com/api/additional/' + employeeId, {
                    headers: {
                         'Authorization': `Bearer ${user.token}`
                    }
               })
     ...
     useEffect(() => {
          const fetchEmp = async () => {
               const response = await fetch('https://generic-coop-backend.onrender.com/api/employee', {
                    headers: {
                         'Authorization': `Bearer ${user.token}`
                    }
               })
     ...
     useEffect(() => {
          const fetchEmp = async () => {
               const response = await fetch('https://generic-coop-backend.onrender.com/api/employee/' + employeeId, {
                    headers: {
                         'Authorization': `Bearer ${user.token}`
                    }
               })
               ...
               if (!isDuplicate) {
                    ...
                    if (isAlreadyApproved) {
                         ...
                         if (
                              ...
                              const response = await fetch(`https://generic-coop-backend.onrender.com/api/payslip/${employeeId}`, {
                                   method: 'PATCH',
                                   body: JSON.stringify(payslip),
                                   headers: {
                                        'Content-Type': 'application/json',
     ...
     const handleApproval = async (transaction) => {
          ...
          if (transaction.approval_status === 'PENDING' || transaction.approval_status === 'REJECTED') {
               ...
               const response = await fetch(`https://generic-coop-backend.onrender.com/api/payslip/${transaction.employee_id}`, {
                    method: 'PATCH',
