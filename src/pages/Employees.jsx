...
const Employees = (props) => {
     ...
     const handleAdd = async (e) => {
          ...
          if (
               ...
               const res = await fetch('https://generic-coop-backend.onrender.com/api/member/', {
                    method: 'POST',
     ...
     const handlePatch = async (e) => {
          ...
          if (
               ...
               const response = await fetch('https://generic-coop-backend.onrender.com/api/employee/' + id, {
                    method: 'PATCH',
                    body: JSON.stringify(employees),
                    headers: {
                         'Content-Type': 'application/json',
